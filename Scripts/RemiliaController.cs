...
public class RemiliaController : MonoBehaviour
{
    ...
    public void ChangeHealth(int amount)
    {
        ...
        if (currentHealth <= 0)
        {
            ...
            controller.kill_num++;
            GameObject projectileObject = Instantiate(projectilePrefab1, transform.position + new Vector3(0, 0.65f, 0), Quaternion.identity);
            Debug.Log("die");
            Destroy(gameObject);
    ...
    void Launch()
    {
        ...
        BatController projectile = projectileObject.GetComponent<BatController>();//从该新对象获取 Projectile 脚本
